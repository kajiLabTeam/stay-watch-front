      ...
      <div className='fixed bottom-0 w-full'>
        <div className='flex h-16 items-center justify-evenly bg-blue-400 text-white'>
          ...
          <Link href={pagesPath.roomHistory.$url()}>
            <a>
              <div
                className={`flex flex-col items-center gap-1 rounded-md py-1 px-2 ${bgColors.roomHistory}`}
              >
          ...
          <Link href={pagesPath.userInformation.$url()}>
            <a>
              <div
                className={`flex flex-col items-center gap-1 rounded-md py-1 px-2 ${bgColors.userInformation}`}
              >
          ...
          <Link href={pagesPath.floorMap.$url()}>
            <a>
              <div
                className={`flex flex-col items-center gap-1 rounded-md py-1 px-2 ${bgColors.floorMap}`}
              >
